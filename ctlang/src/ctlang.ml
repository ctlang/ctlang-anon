...
let verify_opt_doc = "opt Comma separated list of optimzations to verify on the CTLang program. They are run in the order in which they are provided"
...
let () =
  ...
  Core.Command.run ~version:"0.1" ~build_info:"CTLang Compiler" compile_command
